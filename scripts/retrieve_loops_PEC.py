...
if __name__ == '__main__':
    ...
    #loops:
    loops = [1430, 20, 520, 1473, 1203, 1232, 460, 479, 446, 1410, 345, 1406, 304, 1420, 405]
    #controls:
    #loops = [401, 415, 403, 1431, 1429, 400, 404, 432, 433, 445, 412, 420, 407]
    ...
    for loop in loops:
        ...
        f = open(str(_postId)+"_"+output,'w')
        newdoc.writexml(f, indent="", addindent="  ", newl="\n",encoding='utf-8')
        print "For loop: ",_postId," wrote ",i," days to file ", f
